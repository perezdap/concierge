...
### Stdio upstream launchers in the runtime image

Stdio MCP servers are spawned **inside** the gateway container. The runtime
image therefore ships a small toolchain for the most common operator commands:
